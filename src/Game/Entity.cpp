...
Entity::Entity(TerrainElement &terr_el, glm::mat4 &world_transform, bool is_collectible) : terrain_element_(terr_el),
...
void Entity::Draw(glm::vec3 position, float yaw)
{
    terrain_element_.Draw(position, yaw);
}
