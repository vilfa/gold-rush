...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Resizable, fixed"))
    {
        ...
        HelpMarker("Using _Resizable + _SizingPolicyFixed flags.\n"
        ...
        if (ImGui::RadioButton("fit", use_all_width == false))
        {
            use_all_width = false;
        }
        ImGui::SameLine();
        if (ImGui::RadioButton("right-most edge", use_all_width == true))
        {
            use_all_width = true;
        }
    ...
    if (ImGui::TreeNode("Reorderable, hideable, with headers"))
    {
        ...
        if (ImGui::BeginTable("##table2",
                              3,
                              flags | ImGuiTableFlags_SizingPolicyFixed,
                              ImVec2(0.0f, 0.0f)))
        {
            ImGui::TableSetupColumn("One");
            ImGui::TableSetupColumn("Two");
    ...
    if (ImGui::TreeNode("Explicit widths"))
    {
        ...
        {
            // We could also set ImGuiTableFlags_SizingPolicyFixed on the table and all columns will
    ...
    if (ImGui::TreeNode("Columns flags"))
    {
        ...
        const ImGuiTableFlags flags = ImGuiTableFlags_SizingPolicyFixed | ImGuiTableFlags_ScrollX |
    ...
    if (ImGui::TreeNode("Sizing policies, cell contents"))
    {
        ...
        ImGui::CheckboxFlags("ImGuiTableFlags_ScrollX", &flags, ImGuiTableFlags_ScrollX);
        ImGui::CheckboxFlags("ImGuiTableFlags_ScrollY", &flags, ImGuiTableFlags_ScrollY);
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyStretch",
                                 &flags,
                                 ImGuiTableFlags_SizingPolicyStretch))
            flags &= ~ImGuiTableFlags_SizingPolicyFixed; // Can't specify both sizing polices so we
                                                         // clear the other
        ImGui::SameLine();
        HelpMarker(
            "Default if _ScrollX if disabled. Makes columns use _WidthStretch policy by default.");
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyFixed",
                                 &flags,
                                 ImGuiTableFlags_SizingPolicyFixed))
            flags &= ~ImGuiTableFlags_SizingPolicyStretch; // Can't specify both sizing polices so
                                                           // we clear the other
        ImGui::SameLine();
        ...
        static ImGuiTableFlags flags3 = ImGuiTableFlags_SizingPolicyStretch |
        ...
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyStretch",
                                 &flags3,
                                 ImGuiTableFlags_SizingPolicyStretch))
            flags3 &= ~ImGuiTableFlags_SizingPolicyFixed; // Can't specify both sizing polices so we
                                                          // clear the other
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyFixed",
                                 &flags3,
                                 ImGuiTableFlags_SizingPolicyFixed))
            flags3 &= ~ImGuiTableFlags_SizingPolicyStretch; // Can't specify both sizing polices so
                                                            // we clear the other
        ...
        if (ImGui::BeginTable("##table3",
                              7,
                              flags3 | ImGuiTableFlags_SizingPolicyStretch |
                                  ImGuiTableFlags_ContextMenuInBody,
                              outer_size,
                              inner_width))
        {
    ...
    if (ImGui::TreeNode("Outer size"))
    {
        ...
        // Using outer_size.x == 0.0f on a table with no scrolling and no stretch column we can make
        // them tighter.
        ...
        if (ImGui::BeginTable("##table3",
                              3,
                              flags,
                              ImVec2(use_all_width ? -FLT_MIN : 0.0f, TEXT_BASE_HEIGHT * 5.5f)))
        {
            for (int row = 0; row < 10; row++)
            {
                ImGui::TableNextRow();
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        ImGuiTableFlags flags2 = ImGuiTableFlags_Resizable | ImGuiTableFlags_SizingPolicyFixed |
                                 ImGuiTableFlags_Reorderable | ImGuiTableFlags_Hideable |
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        static ImGuiTableFlags flags =
            ...
            ImGuiTableFlags_ScrollY | ImGuiTableFlags_SizingPolicyFixed;
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Sizing:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyStretch",
                                         &flags,
                                         ImGuiTableFlags_SizingPolicyStretch))
                    flags &= ~ImGuiTableFlags_SizingPolicyFixed; // Can't specify both sizing
                ...
                if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyFixed",
                                         &flags,
                                         ImGuiTableFlags_SizingPolicyFixed))
                    flags &= ~ImGuiTableFlags_SizingPolicyStretch; // Can't specify both sizing
                                                                   // polices so we clear the other
                ImGui::SameLine();
                ...
                ImGui::CheckboxFlags("ImGuiTableFlags_SameWidths",
                                     &flags,
